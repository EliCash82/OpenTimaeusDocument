...
class AnnotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annotation" do
    assert_difference('Annotation.count') do
      post annotations_url, params: { annotation: { source: @annotation.source, text: @annotation.text, title: @annotation.title } }
    end
  ...
  test "should update annotation" do
    patch annotation_url(@annotation), params: { annotation: { source: @annotation.source, text: @annotation.text, title: @annotation.title } }
